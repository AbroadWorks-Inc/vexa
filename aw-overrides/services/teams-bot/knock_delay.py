...
is never invited, so the meeting platform (Meet/Zoom/Teams) always drops it into
a waiting room and a human has to admit it. Asking to join 10 minutes early means
...
5 of its 15 minutes of patience overlapped with a human being in the room.
...
#: that has not asked yet. Teams' pre-join walk is the longest of the three
